...
with open('C:/Users/alfon/Desktop/Universidad/Tercero/APSE/APSELogisticSimulator/data/prediccionOnline/travelModel.pkl', 'rb') as f:
    modelo_tiempo_viaje = pickle.load(f)
with open('C:/Users/alfon/Desktop/Universidad/Tercero/APSE/APSELogisticSimulator/data/prediccionOnline/deliveryModel.pkl', 'rb') as f:
    modelo_tiempo_entrega = pickle.load(f)
with open('C:/Users/alfon/Desktop/Universidad/Tercero/APSE/APSELogisticSimulator/data/prediccionOnline/le.pkl', 'rb') as f:
...
def obtenerPlan(evento):
    ...
    # Cerrar la conexión
    client.close()
    print("Se ha obtenido el plan de la base de datos para el truck_id", evento["truckId"], "y el simulationId", evento["simulationId"])
    return
...
def actualizarVectores(evento):
    ...
    if (evento["eventType"] in ["Truck departed", "Truck departed to depot"]):
        ...
        print("Se ha actualizado el vector para el truck_id", evento["truckId"], "y el simulationId", evento["simulationId"])
...
def prediccionDeTiempoDeViaje(evento):
    ...
    print("La predicción de tiempo de viaje para el truck_id", evento["truckId"], "y el simulationId", evento["simulationId"], "es", prediccion)
    # print("La predicción era", vector[0], "la predicción es", prediccion)
    return prediccion
...
def prediccionDeTiempoDeEntrega(evento):
    ...
    print("La predicción de tiempo de entrega para el truck_id", evento["truckId"], "y el simulationId", evento["simulationId"], "es", prediccion)
    return prediccion
...
def escribirEnKafka(prediccion):
    ...
    mensaje = f"Tiempo estimado {prediccion}" # DECIDIR EL FORMATO DE LOS MENSAJES CON LAS PREDICCIONES
